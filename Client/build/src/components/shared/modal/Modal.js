...
const Modal = () => {
    ...
    const {user} = useSelector(state => state.auth) // auth ke ander we have -> loading, error, user(we are trying to get user here)
  ...
  return (
    <>
      <div className="modal" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyborad='false' tabIndex={-1} aria-labelledby='staticBackdropLabel' aria-hidden='true'>
        <div className="modal-dialog">
            ...
            <div className="modal-body">
                ...
                <select className="form-select" aria-label="Default select example" onChange={(e) => setBloodGroup(e.target.value)}>
                    <option defaultValue={"Select a blood group"}>Select a blood group</option>
